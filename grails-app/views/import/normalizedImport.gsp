		...
		<div class="entity-form-container togglable">
			<div class="entity-form-header">
				...
				<g:form url="[controller:'normalizedImporterEntity', action:'uploader']" useToken="true" method="post" enctype="multipart/form-data">
					<g:selectFromList name="dataElement.id" label="Data element" bean="${normalizedImporterEntity}" field="dataElement" optionKey="id" multiple="false"
					...
					<g:selectFromList name="period.id" label="Period" bean="${normalizedImporterEntity}" field="period" optionKey="id" multiple="false"
					from="${periods}" value="${importerEntity?.period?.id}" optionValue="startDate" />
					
					<g:file name="file" label="File" bean="${normalizedImporterEntity}" field="file"/>
					<div class="row">
