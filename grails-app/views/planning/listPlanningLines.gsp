      ...
      <div class="main">
        ...
        <ul class='clearfix' id='questions'>
          <li class='question push-20'>
            <a href="#" class="next medium gray right">Create New Service</a>
            <h4 class='section-title'> <span class='question-default'> <img src="/kevin/static/PnPNkVfHIpcScmB9ptVadgIVvvaqw4c5Kn0odzx0exg.png" /> </span>Manage Services</h4>
            <div class="table-wrap">
              <table class="listing">
                <thead>
                  <tr>
                    ...
                    <th>Activity</th>
                    <th>Service Area</th>
                    <th>Est. 2012 Instances</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td class="status pos"></td>
                    <td><a href="#">Malaria Consultations</a></td>
                    <td>CPC</td>
                    <td>467</td>
                  ...
                  <tr>
                    <td class="status pos"></td>
                    <td><a href="#">Provide Condoms</a></td>
                  ...
                  <tr>
                    <td class="status neg"></td>
                    <td><a href="#">Provide ARVs</a></td>
                    <td>HIV Care & Prevention</td>
                    <td>550</td>
                    <td><a class="edit-link" href="#">edit</a><a class="delete-link" href="#">delete</a></td>
                  </tr>
                </tbody>
              ...
              <ul class="table-nav">
                <li><a class="selected" href="#">Basic Info</a></li>
                <li><a href="#">Staffing</a></li>
                <li><a href="#">Testing</a></li>
                <li><a href="#">Medicine</a></li>
                <li><a href="#">Hospital/Ambulance</a></li>
                <li><a href="#">Monthly Instances</a></li>
                  ...
                  <tbody>
                    ...
                    <tr style="display: table-row" class="sub_tree">
                      <td colspan="7" class="bucket">
                        <table>
                          ...
                          <tr class="tree_sign_minus">
                            <td><span style="margin-left: 20px;">General Funding</span></td>
                            <td>-</td>
                            <td>80</td>
                            <td>80</td>
                            <td><input type="checkbox"></td>
                          ...
                          <tr style="display: table-row" class="sub_tree">
                            <td colspan="7" class="bucket">
                              <table>
                                ...
                                <tr>
                                  <td><span style="margin-left: 40px;">Medicine & Consumables</span></td>
                                  <td>-</td>
                                  <td>10</td>
                                  <td>-</td>
                                  <td></td>
                                ...
                                <tr>
                                  <td><span style="margin-left: 40px;">District Hospital</span></td>
                                  <td>(5)</td>
                                  <td>-</td>
                                  <td>-</td>
                                  <td></td>
                                ...
                                <tr>
                                  <td><span style="margin-left: 40px;">Minisante</span></td>
                                  <td>(12)</td>
                                  <td>-</td>
                                  <td>-</td>
                                  <td></td>
                          ...
                          <tr class="tree_sign_plus">
                            <td><span style="margin-left: 20px;">HPV Vaccination Campaign</span></td>
                            <td>(50)</td>
                            <td>60</td>
                            <td>10</td>
                            <td><input type="checkbox"></td>
                          ...
                          <tr class="sub_tree">
                            <td colspan="7" class="bucket">
                              <table>
                                <tbody><tr>
                                  <td><span style="margin-left: 40px;">Lorem</span></td>
                                  <td>1</td>
                                  <td>1</td>
                                  <td>1</td>
                                </tr>
                                <tr>
                                  <td><span style="margin-left: 40px;">Ipsum</span></td>
                                  <td>5</td>
                                  <td>5</td>
                                  <td>5</td>
                                </tr>
                    ...
                    <tr class="sub_tree">
                      <td colspan="7" class="bucket">
                        <table>
                          <tbody><tr>
                            <td><span style="margin-left: 20px;">Lorem</span></td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                          </tr>
