				...
				<td>
					<div class="js_dropdown dropdown"> 
						...
						<div class="hidden manage-list dropdown-list js_dropdown-list">
							<ul>
								<li>
									<a href="${createLink(controller:'planningCost', action:'list', params:[planningType:planningType.id])}"><g:message code="default.list.label" args="[message(code:'planning.planningCost.label',default:'Planning Cost')]" /></a>
								</li>
							</ul>
						</div>
					</div> 		
