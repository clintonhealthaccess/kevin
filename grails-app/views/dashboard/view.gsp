		    	...
		    	<div id="center" class="box">
		    		<div id="values">
			    		...
			    		<g:if test="${true || user.admin}">
							...
							<div class="clear"></div>
							<div><a href="${createLink(controller:'dashboard', action:'refresh', params:[period: dashboard.currentPeriod.id, objective: dashboard.currentObjective.id, organisation: dashboard.currentOrganisation.id])}">trigger refresh</a></div>
				    	</g:if>
				    	<!-- ADMIN SECTION END -->
