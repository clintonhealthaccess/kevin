...
<div>
	<span class="bold"><g:message code="survey.checkboxquestion.checkboxoption.label" default="Option Name"/>:</span><span> ${i18n(field: option.names)}</span>
</div>
<div>
	<span class="bold"><g:message code="dataelement.label" default="Data Element"/>:</span><span>${i18n(field:option.surveyElement?.dataElement?.names)}</span>
</div>
<div>
	<span class="bold"><g:message code="facility.type.label" default="Facility Groups"/>:</span><span> ${option.groupUuidString}</span>
</div>