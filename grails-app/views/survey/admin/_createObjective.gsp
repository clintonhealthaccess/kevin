<div id="add-objective" class="entity-form-container togglable">
	<div class="entity-form-header">
		<h3 class="title">
			<g:message code="default.new.label" args="${[message(code:'general.text.objective',default:'Objective')]}"/>
		</h3>
		<g:locales />
		<div class="clear"></div>
	</div>
	...
	<g:form url="[controller:'objective', action:'save']" useToken="true">
		...
		<div class="row">
			...
			<label><g:message code="general.text.survey" default="Survey"/>:</label> <g:i18n field="${objective.survey.names}"/>
		</div>
		<div class="row">
