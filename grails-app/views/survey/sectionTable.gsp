  			...
  			<tbody>
  				<g:each in="${summaryPage.sections}" var="section">
  					...
  					<tr>
  						...
  						<td>
	  						<a href="${createLink(controller: 'editSurvey', action: 'sectionPage', params: [section: section.id, organisation: summaryPage.organisation.id])}"><g:message code="survey.viewsurvey.label" default="View Survey"/></a>
