<table class="listing">
	<thead>
		<tr>
			...
			<th><g:message code="formelement.validationrule.allowoutlier.label" default="Allow Outlier"/></th>
			<th><g:message code="facility.type.label" default="Facility Groups"/></th>
			<th><g:message code="formelement.validationrule.message.label" default="Message"/></th>
			...
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
				<td>
					<ul class="horizontal">
						...
						<li>
							<a class="delete-link" href="${createLinkWithTargetURI(controller:'formValidationRule', action:'delete', params:[id: validationRule.id])}" onclick="return confirm('\${message(code: 'default.link.delete.confirm.message', default: 'Are you sure?')}');">
				...
				<td>
					<div class="js_dropdown dropdown"> 
						...
						<div class="hidden manage-list dropdown-list js_dropdown-list">
							<ul>
								<li>
							 		<a href="${createLinkWithTargetURI(controller:'formValidationRule', action:'copy', params:[id: validationRule.id])}"><g:message code="formelement.validationrule.clone.label" default="Clone" /> </a>
								</li>
							</ul>
						</div>
					</div> 		
