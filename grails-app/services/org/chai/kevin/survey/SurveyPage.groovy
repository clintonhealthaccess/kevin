...
//	}
	...
	public boolean isReadonly(SurveyProgram surveyProgram) {
		return !surveyProgram.getSurvey().getActive() || !SecurityUtils.getSubject().isPermitted("editSurvey:save:"+dataLocation.getId()) || programs.get(program).getClosed(); 
	}
}
