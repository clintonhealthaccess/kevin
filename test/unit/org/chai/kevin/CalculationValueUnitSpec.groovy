...
class CalculationValueUnitSpec extends UnitSpec {
	...
	def "test average"() {
		setup:
		def partialValue1 = new AveragePartialValue(value: v("1"), numberOfFacilities: 1)
		def partialValue2 = new AveragePartialValue(value: v("14"), numberOfFacilities: 2)
		def partialValue3 = new AveragePartialValue(value: v("27"), numberOfFacilities: 3)
