...
REM linkd.exe is only for NTFS partitions (creates NTFS junction points)mkdir "C:\Users\user\CHAI\DHSST\dhsst-Conf\grails-2.0.0.M2\grails-2.0.0.M2\eclipse-cpvars"
cd "C:\Users\user\CHAI\DHSST\dhsst-Conf\grails-2.0.0.M2\grails-2.0.0.M2\eclipse-cpvars"
linkd "GRAILS_IVYCACHE" "C:\Users\user\.grails\ivy-cache"
linkd "GRAILS_WORKDIR" "C:\Users\user\.grails\2.0.0.M2"
echo Links installed to C:\Users\user\CHAI\DHSST\dhsst-Conf\grails-2.0.0.M2\grails-2.0.0.M2\eclipse-cpvars. Delete these with linkd directory /d or delrp directory command.
